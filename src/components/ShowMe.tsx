...
export function ShowMe() {
  ...
  const chatArea = (
    <div className="w-full h-full relative">
      <Particles count={6} />
      <div className="w-full max-w-2xl mx-auto px-3 sm:px-6 py-4 sm:py-6 space-y-3 sm:space-y-4 relative z-10">
          ...
          <motion.div key={i} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }}
            ...
            {ex.speaker === "customer" ? (
              <div className="max-w-[95%] sm:max-w-[85%]">
                ...
                <div className="chat-customer p-3 sm:p-4">
  ...
  const bottomBar = allRevealed ? (
    <div className="glass-panel px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-center gap-2 sm:gap-4 flex-wrap"
      ...
      <button onClick={resetGame} className="btn-ghost px-4 sm:px-6 py-2.5">
        <ArrowLeft size={12} /> LOBBY
      </button>
      <button onClick={() => {
